...
As the town detective, your task is to find these two sneaky
numbers. Return an array of size two containing the two
...
def two_nums(list1 :list[int]):
    list2 = [nums for index,nums in enumerate(list1) if nums in list1[index+1:]]
    return list2


print(two_nums([7,1,5,4,3,4,6,0,9,5,8,2]))
